static const char help_str[] = {
  ...
  "Scope the following --bar properties to a subset of displays\n"
  "      --display <selector> --bar <setting>=<value>\n"
  "                                  \tSELECTOR is a comma separated list of\n"
  "                                  \tarrangement indices and the keywords\n"
  "                                  \tall, main and notched\n"
  "                                  \tCurrently honored by topmost and\n"
  "                                  \tshow_in_fullscreen\n\n"
